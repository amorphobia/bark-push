...
export default {
  ...
  push: {
    ...
    advanced: {
      ...
      subtitle: 'Subtitle',
      subtitlePlaceholder: 'Notification subtitle',
      badge: 'Badge',
      level: 'Level',
      levelOptions: {
        active: 'Active',
      ...
      volume: 'Volume',
      volumeHelp: '0-10 (default: 5)',
      call: 'Call',
      callHelp: 'Repeat ringtone for 30 seconds',
      copy: 'Copy Content',
      copyPlaceholder: 'Custom content to copy',
      action: 'Action',
      actionOptions: {
        none: 'None',
        passive: 'Passive',
  ...
  settings: {
    ...
    customHeadersPlaceholder: 'Add one header per line in "Name: Value" format.\n\nExample:\nAuthorization: Bearer Token\nX-Custom-Header: value',
